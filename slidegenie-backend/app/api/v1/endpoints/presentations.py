        ...
        try:
            ...
            if not settings.SUPABASE_URL or not settings.SUPABASE_SERVICE_KEY:
                raise HTTPException(
                    ...
                    detail="Supabase storage service is not configured. Please contact support."
                )
            
            storage_manager = StorageManager()
            await storage_manager.initialize()
            
            # Use store_document method which handles storage properly
            ...
            file_key = storage_info["storage_path"]
        except HTTPException:
            raise
        except Exception as e:
